  ...
  return (
    ...
    >
      ...
      >
        <AlertCircle size={20} />
        <span>
          A {duplicateItem.type} named{" "}
          <strong>"{duplicateItem.originalName}"</strong> already exists. Import
          it as a copy or replace the existing one?
        </span>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ ...duplicateItem, proposedName: e.target.value })
          }
          style={{ width: "100%" }}
          autoFocus
          onKeyDown={(e) => {
