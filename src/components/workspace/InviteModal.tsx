      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <button
                ...
                disabled={
                  loading || !email || selectedWorkspaceIds.length === 0
                }
              >
                {loading ? (
              ...
              >
                {memberWorkspaces.map((memberWorkspace) => {
                  ...
                  const canManageMembers =
                    !!memberWorkspace.ownerId &&
                    memberWorkspace.ownerId === user?.id;
                  ...
                  return (
                    ...
                    >
                      ...
                      {members.length > 0 ? (
                        members.map((member) => {
                          const isOwner =
                            member.userId === memberWorkspace.ownerId;
                          return (
                            <div
          ...
          <div>
            ...
            >
              Anyone with this link can join the selected workspaces. The link
              will open SyncArts directly.
            </p>
          </div>
