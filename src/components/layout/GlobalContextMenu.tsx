...
export function GlobalContextMenu() {
  const [menuConfig, setMenuConfig] = useState<{ x: number; y: number; textToCopy: string } | null>(null);
    ...
    >
      <button
        ...
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();
          navigator.clipboard.writeText(menuConfig.textToCopy).catch(console.error);
          setMenuConfig(null);
        }}
