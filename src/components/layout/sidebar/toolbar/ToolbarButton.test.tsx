...
describe("ToolbarButton", () => {
  test("renders tooltip and icon", () => {
    const { container } = render(<ToolbarButton tooltip="Test Tooltip" icon={Activity} onClick={mock()} />);
  ...
  test("calls onClick", () => {
    const onClick = mock();
    const { container } = render(<ToolbarButton tooltip="Test" icon={Activity} onClick={onClick} />);
    const div = container.firstChild as HTMLDivElement;
    fireEvent.click(div);
