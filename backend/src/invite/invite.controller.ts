import { Controller, Post, Get, Body, Param, UseGuards, Request, BadRequestException, Inject } from '@nestjs/common';
...
function normalizeWorkspaceIds(body: { workspaceId?: string; workspaceIds?: string[] }) {
...
export class InviteController {
  ...
  async generateLink(@Body() body: any, @Request() req: any) {
    try {
      ...
      }, req.authUser.id, parsed.expiresInDays);
    } catch (e: any) {
